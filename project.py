...
background_image = pygame.transform.scale(pygame.image.load("bg.png").convert(),(SCREEN_WIDTH, SCREEN_HEIGHT))
 
wildlife_image = pygame.transform.scale(pygame.image.load("image.png").convert_alpha(),(120, 220))
...
heading_text = heading_font.render("Wildlife Spotlight: Giraffe",True,pygame.Color("black"))
heading_rect = heading_text.get_rect(center=(SCREEN_WIDTH // 2, 45))
fact_text = fact_font.render("Giraffe are very tall.",True,pygame.Color("White"))
